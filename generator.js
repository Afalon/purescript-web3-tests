...
(function(exports) {
  ...
  var parseString = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("string"))(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(SolidityString.value);
  });
  var parseBytesD = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("bytes"))(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(SolidityBytesD.value);
  });
  var parseBool = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("bool"))(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(SolidityBool.value);
  });
  var parseAddress = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("address"))(function (v) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(SolidityAddress.value);
  });
  var numberParser = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_String.fromCharArray)(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_Token.digit(Data_Identity.monadIdentity))))(function (v) {
      var v1 = Data_Int.fromString(v);
      if (v1 instanceof Data_Maybe.Nothing) {
          return Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Couldn't parse as Natural : " + v);
      };
      if (v1 instanceof Data_Maybe.Just) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(v1.value0);
      };
      throw new Error("Failed pattern match at Data.AbiParser line 79, column 3 - line 81, column 25: " + [ v1.constructor.name ]);
  });
  var parseBytesN = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("bytes"))(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(numberParser)(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new SolidityBytesN(v1));
      });
  });
  var parseBytes = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseBytesN))(parseBytesD);
  var $$parseInt = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("int"))(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(numberParser)(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new SolidityInt(v1));
      });
  });
  var parseUint = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("uint"))(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(numberParser)(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new SolidityUint(v1));
      });
  });
  var solidityBasicTypeParser = Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseUint), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)($$parseInt), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseAddress), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseBool), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseString), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseBytes), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseAddress) ]);
  var parseArray = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(solidityBasicTypeParser)(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("[]"))(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new SolidityArray(v));
      });
  });
  var parseVector = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(solidityBasicTypeParser)(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("["))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("]"))(numberParser))(function (v1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new SolidityVector(v1, v));
      });
  });
  var solidityTypeParser = Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseArray), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseVector), Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(solidityBasicTypeParser) ]);
  var parseSolidityType = function (s) {
      return Data_EitherR.fmapL(Text_Parsing_Parser.parseErrorMessage)(Text_Parsing_Parser.runParser(s)(solidityTypeParser));
  };                                             
  ...
  var formatSolidityType = new Format(function (s) {
      ...
      if (s instanceof SolidityVector) {
          return format(formatSolidityType)(s.value1) + ("[" + (Data_Show.show(Data_Show.showInt)(s.value0) + "]"));
      };
      if (s instanceof SolidityArray) {
          return format(formatSolidityType)(s.value0) + "[]";
      };
      throw new Error("Failed pattern match at Data.AbiParser line 47, column 14 - line 58, column 1: " + [ s.constructor.name ]);
  });
  ...
  var decodeJsonSolidityType = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("type"))(function (v1) {
              ...
              throw new Error("Failed pattern match at Data.AbiParser line 136, column 5 - line 138, column 29: " + [ v2.constructor.name ]);
          });
      });
  });
  var decodeJsonSolidityFunction = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("name"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonSolidityType))(v)("inputs"))(function (v2) {
  ...
  var decodeJsonSolidityConstructor = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonSolidityType))(v)("inputs"))(function (v1) {
  ...
  exports["parseBytesD"] = parseBytesD;
  exports["parseBytesN"] = parseBytesN;
...
(function(exports) {
  ...
  var Network_Ethereum_Web3_Types_Unit = PS["Network.Ethereum.Web3.Types.Unit"];
  var Prelude = PS["Prelude"];
...
(function(exports) {
  ...
  var ParserMethod = (function () {
      function ParserMethod(value0) {
          this.value0 = value0;
      };
      ParserMethod.create = function (value0) {
          return new ParserMethod(value0);
      };
      return ParserMethod;
  })();
  var HelperFunction = (function () {
      function HelperFunction(value0) {
          this.value0 = value0;
      };
      HelperFunction.create = function (value0) {
          return new HelperFunction(value0);
      };
  ...
  var DataDecl = (function () {
      function DataDecl(value0) {
          this.value0 = value0;
      };
      DataDecl.create = function (value0) {
          return new DataDecl(value0);
      };
      return DataDecl;
  })();
  var BuilderMethod = (function () {
      function BuilderMethod(value0) {
          this.value0 = value0;
      };
      BuilderMethod.create = function (value0) {
          return new BuilderMethod(value0);
      };
      return BuilderMethod;
  })();
  var AbiEncodingInstance = (function () {
      function AbiEncodingInstance(value0) {
          this.value0 = value0;
      };
      AbiEncodingInstance.create = function (value0) {
          return new AbiEncodingInstance(value0);
      };
      return AbiEncodingInstance;
  })();
  var FunctionCodeBlock = (function () {
      function FunctionCodeBlock(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      FunctionCodeBlock.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new FunctionCodeBlock(value0, value1, value2);
              };
          };
      };
  ...
  var vectorLength = function (n) {
      return "N" + Data_Show.show(Data_Show.showInt)(n);
  };
  var toTransportPrefix = function (isCall) {
      return function (outputCount) {
          var modifier = (function () {
              var $55 = isCall && outputCount === 1;
              if ($55) {
                  return "unSingleton <$> ";
              };
              return "";
  ...
  var toSelector = function (v) {
      var args = Data_Functor.map(Data_Functor.functorArray)(function (i) {
          return Data_AbiParser.format(Data_AbiParser.formatSolidityType)(i);
      })(v.value0.inputs);
      var v1 = Network_Ethereum_Web3_Types_Sha3.sha3(Network_Ethereum_Web3_Types_Sha3.stringSha3)(v.value0.name + ("(" + (Data_String.joinWith(",")(args) + ")")));
      return Network_Ethereum_Web3_Types_Types.HexString(Data_String.take(8)(v1));
  };
  var toReturnType = function (constant) {
      return function (outputs) {
          var $60 = !constant;
          if ($60) {
              return "Web3 p e HexString";
          };
          return "Web3 p e " + (function () {
              var v = Data_Array.length(outputs);
              if (v === 0) {
                  return "()";
              };
              if (v === 1) {
              ...
              return "(Tuple" + (Data_Show.show(Data_Show.showInt)(Data_Array.length(outputs)) + (" " + (Data_String.joinWith(" ")(outputs) + ")")));
          })();
      };
  };
  var toPayload = function (constr) {
      return function (args) {
          var v = Data_Array.length(args);
          if (v === 0) {
              return constr;
          };
          return "(" + (constr + (" " + (Data_String.joinWith(" ")(args) + ")")));
      };
  };
  var sendSigPrefix = [ "Maybe Address", "Address", "u" ];
  var parseAbi = function (v) {
      return function (abiJson) {
          ...
          if (v.truffle) {
              var mabi = Data_Lens_Fold.previewOn(abiJson)(function ($182) {
                  return Data_Argonaut_Prisms._Object(Data_Lens_Internal_Forget.choiceForget(Data_Maybe_First.monoidFirst))(Data_Lens_Index.ix(Data_Lens_Index.indexStrMap)("abi")(Data_Lens_Internal_Forget.wanderForget(Data_Maybe_First.monoidFirst))($182));
              });
          ...
          throw new Error("Failed pattern match at Data.Generator line 423, column 30 - line 426, column 75: " + [ v.truffle.constructor.name ]);
      };
  };
  var makeDigits = function (n) {
      ...
      var ddigits = Data_Functor.map(Data_Functor.functorArray)(function (a) {
          return "D" + a;
      })(digits);
      var consed = Data_String.joinWith(" :& ")(ddigits);
      var $67 = Data_Array.length(ddigits) === 1;
      if ($67) {
          return consed;
      };
      return "(" + (consed + ")");
  ...
  var toPSType = function (s) {
      ...
      if (s instanceof Data_AbiParser.SolidityUint) {
          return "(" + ("UIntN " + (makeDigits(s.value0) + ")"));
      };
      if (s instanceof Data_AbiParser.SolidityInt) {
          return "(" + ("IntN " + (makeDigits(s.value0) + ")"));
      };
      if (s instanceof Data_AbiParser.SolidityString) {
          return "String";
      };
      if (s instanceof Data_AbiParser.SolidityBytesN) {
          return "(" + ("BytesN " + (makeDigits(s.value0) + ")"));
      };
      if (s instanceof Data_AbiParser.SolidityBytesD) {
          return "ByteString";
      };
      if (s instanceof Data_AbiParser.SolidityVector) {
          return "(" + ("Vector " + (vectorLength(s.value0) + (" " + (toPSType(s.value1) + ")"))));
      };
      if (s instanceof Data_AbiParser.SolidityArray) {
          return "(" + ("Array " + (toPSType(s.value0) + ")"));
      };
      throw new Error("Failed pattern match at Data.Generator line 72, column 14 - line 83, column 1: " + [ s.constructor.name ]);
  };
  ...
  var imports = Data_String.joinWith("\x0a")([ "import Prelude", "import Data.Generic.Rep as G", "import Data.Generic.Rep.Eq as GEq", "import Data.Generic.Rep.Show as GShow", "import Data.Monoid (mempty)", "import Data.Lens ((.~))", "import Text.Parsing.Parser (fail)", "import Data.Maybe (Maybe(..))", "import Network.Ethereum.Web3.Types (class Unit, HexString(..), CallMode, Web3, BigNumber, _address, _topics, _fromBlock, _toBlock, defaultFilter)", "import Network.Ethereum.Web3.Provider (class IsAsyncProvider)", "import Network.Ethereum.Web3.Contract (class EventFilter, call, sendTx)", "import Network.Ethereum.Web3.Solidity" ]);
  var genPSModuleStatement = function (opts) {
      return function (fp) {
          return "module Contracts." + (Node_Path.basenameWithoutExt(fp)(".purs") + " where\x0a");
      };
  };
  ...
  var eventToDataDecl = function (v) {
      return new DataDecl({
          ...
          factorTypes: Data_Functor.map(Data_Functor.functorArray)(function ($183) {
              return toPSType((function (v1) {
                  return v1.value0.type;
              })($183));
          })(v.value0.inputs)
      });
  };
  var eventToParserNoArgs = function (v) {
      var v1 = eventToDataDecl(v);
      return new ParserMethod({
          parserExpr: "pure " + v1.value0.constructor
      });
  };
  var eventToParserSomeArgs = function (v) {
      var fromTuple = function (c) {
          return function (n) {
              return "uncurry" + (Data_Show.show(Data_Show.showInt)(n) + (" " + c));
          };
      };
      var fromSingleton = function (c) {
          return "uncurry1 " + c;
      };
      var v1 = eventToDataDecl(v);
      var starter = (function () {
          var $85 = Data_Array.length(v1.value0.factorTypes) === 1;
          if ($85) {
              return fromSingleton(v1.value0.constructor);
          };
          return fromTuple(v1.value0.constructor)(Data_Array.length(v1.value0.factorTypes));
      })();
      return new ParserMethod({
          parserExpr: starter + " <$> fromDataParser"
      });
  };
  var eventToParser = function (v) {
      var $89 = Data_Array.length(v.value0.inputs) === 0;
      if ($89) {
          return eventToParserNoArgs(v);
      };
      return eventToParserSomeArgs(v);
  };
  ...
  var codeHelperFunction = new Code(function (v) {
      return function (v1) {
          ...
          var decl = v.value0.unpackExpr.name + (" :: " + ("forall p e u. Unit u => IsAsyncProvider p => " + Data_String.joinWith(" -> ")(v.value0.signature)));
          return decl + ("\x0a" + (defL + (" = " + defR)));
      };
  });
  var codeEventGenericInstance = new Code(function (v) {
      return function (v1) {
          ...
          return Data_String.joinWith("\x0a\x0a")(Data_Array.cons(v.value0.genericDeriving)(instances));
      };
  });
  var codeEventFilterInstance = new Code(function (v) {
      return function (v1) {
          ...
          return Data_String.joinWith("\x0a")([ header, eventFilter ]);
      };
  });
  var codeDataDecl = new Code(function (v) {
      return function (v1) {
          return "data " + (v.value0.constructor + (" = " + (v.value0.constructor + (" " + Data_String.joinWith(" ")(v.value0.factorTypes)))));
      };
  });
  var codeAbiEncodingInstance = new Code(function (v) {
      return function (v1) {
          var prsr = "\x09" + v.value0.parser;
          var header = "instance " + (v.value0.instanceName + (" :: ABIEncoding " + (v.value0.instanceType + " where")));
          var bldr = "\x09" + v.value0.builder;
          return Data_String.joinWith("\x0a")([ header, bldr, prsr ]);
      };
  });
  var codeFunctionCodeBlock = new Code(function (v) {
      return function (opts) {
          if (v instanceof FunctionCodeBlock) {
              var sep = Data_String.fromCharArray(Data_Array.replicate(80)("-"));
              var comment = "-- | " + v.value0.value0.constructor;
              var header = sep + ("\x0a" + (comment + ("\x0a" + sep)));
              return Data_String.joinWith("\x0a\x0a")([ header, genCode(codeDataDecl)(v.value0)(opts), genCode(codeAbiEncodingInstance)(v.value1)(opts), genCode(codeHelperFunction)(v.value2)(opts) ]);
          };
          if (v instanceof EventCodeBlock) {
              var sep = Data_String.fromCharArray(Data_Array.replicate(80)("-"));
              var comment = "-- | " + v.value0.value0.constructor;
              var header = sep + ("\x0a" + (comment + ("\x0a" + sep)));
              return Data_String.joinWith("\x0a\x0a")([ header, genCode(codeDataDecl)(v.value0)(opts), genCode(codeAbiEncodingInstance)(v.value1)(opts), genCode(codeEventFilterInstance)(v.value2)(opts), genCode(codeEventGenericInstance)(v.value3)(opts) ]);
          };
          throw new Error("Failed pattern match at Data.Generator line 343, column 1 - line 343, column 49: " + [ v.constructor.name, opts.constructor.name ]);
      };
  });
  ...
  var eventToEncodingInstance = function (v) {
      var v1 = eventToParser(v);
      return new AbiEncodingInstance({
          instanceType: capitalize(v.value0.name), 
          instanceName: "abiEncoding" + capitalize(v.value0.name), 
          builder: "toDataBuilder = const mempty", 
          parser: "fromDataParser = " + v1.value0.parserExpr
      });
  };
  var eventToEventFilterInstance = function (v) {
      ...
      var indexedVals = (function () {
          var $126 = nIndexedArgs === 0;
          if ($126) {
              return "";
          };
          return "," + Data_String.joinWith(",")(Data_Array.replicate(nIndexedArgs)("Nothing"));
      })();
      var eventIdStr = "Just (" + ("HexString " + ("\"" + (Network_Ethereum_Web3_Types_Types.unHex(eventId(v)) + ("\"" + ")"))));
      var mkFilterExpr = function (addr) {
          return Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString)([ "defaultFilter", "\x0a\x09\x09", Data_String.joinWith("\x0a\x09\x09")([ "# _address .~ Just " + addr, "# _topics .~ Just [" + (eventIdStr + (indexedVals + "]")), "# _fromBlock .~ Nothing", "# _toBlock .~ Nothing" ]) ]);
      };
      var v1 = eventToDataDecl(v);
      return new EventFilterInstance({
  ...
  var eventToEventGenericInstance = function (v) {
      ...
      return new EventGenericInstance({
  ...
  var eventToEventCodeBlock = function (v) {
      return new EventCodeBlock(eventToDataDecl(v), eventToEncodingInstance(v), eventToEventFilterInstance(v), eventToEventGenericInstance(v));
  };
  var funToDataDecl = function (v) {
      return function (opts) {
          return new DataDecl({
              constructor: capitalize(opts.prefix + (v.value0.name + "Fn")), 
              factorTypes: Data_Functor.map(Data_Functor.functorArray)(toPSType)(v.value0.inputs)
          });
      };
  };
  var funToBuilderNoArgs = function (v) {
      return function (opts) {
          var selectorBuilder = "HexString " + ("\"" + (Network_Ethereum_Web3_Types_Types.unHex(toSelector(v)) + "\""));
          var v1 = funToDataDecl(v)(opts);
          return new BuilderMethod({
              unpackExpr: v1.value0.constructor, 
              builderExpr: selectorBuilder
          });
      };
  };
  var funToBuilderSomeArgs = function (v) {
      return function (opts) {
          var toTuple = function (vars) {
              return "(Tuple" + (Data_Show.show(Data_Show.showInt)(Data_Array.length(vars)) + (" " + (Data_String.joinWith(" ")(vars) + ")")));
          };
          var toSingleton = function (x) {
              return "(Singleton " + (x + ")");
          };
          ...
          var restBuilder = (function () {
              var $147 = Data_Array.length(vars) === 1;
              if ($147) {
                  return " <> toDataBuilder " + toSingleton(vars[0]);
              };
              return " <> toDataBuilder " + toTuple(vars);
          })();
          return new BuilderMethod({
              unpackExpr: "(" + (v1.value0.constructor + (" " + (Data_String.joinWith(" ")(vars) + ")"))), 
              builderExpr: selectorBuilder + restBuilder
          });
      };
  };
  var funToBuilder = function (v) {
      return function (opts) {
          var $152 = Data_Array.length(v.value0.inputs) === 0;
          if ($152) {
              return funToBuilderNoArgs(v)(opts);
          };
          return funToBuilderSomeArgs(v)(opts);
      };
  };
  var funToEncodingInstance = function (v) {
      return function (opts) {
          var v1 = funToBuilder(v)(opts);
          var v2 = funToDataDecl(v)(opts);
          return new AbiEncodingInstance({
              instanceType: v2.value0.constructor, 
              instanceName: "abiEncoding" + v2.value0.constructor, 
              builder: "toDataBuilder " + (v1.value0.unpackExpr + (" = " + v1.value0.builderExpr)), 
              parser: "fromDataParser = fail \"Function type has no parser.\""
          });
      };
  };
  var callSigPrefix = [ "Address", "Maybe Address", "CallMode" ];
  var funToHelperFunction = function (v) {
      return function (opts) {
          var v1 = funToDataDecl(v)(opts);
          var stockVars = [ "x0", "x1", "u" ];
          var sigPrefix = (function () {
              if (v.value0.constant) {
                  return callSigPrefix;
              };
              return sendSigPrefix;
          })();
          var offset = Data_Array.length(stockVars);
          var helperTransport = toTransportPrefix(v.value0.constant)(Data_Array.length(v.value0.outputs));
          var conVars = Data_Array.mapWithIndex(function (i) {
              return function (v2) {
                  return "x" + Data_Show.show(Data_Show.showInt)(offset + i | 0);
              };
          })(v.value0.inputs);
          var helperPayload = toPayload(v1.value0.constructor)(conVars);
          return new HelperFunction({
              signature: Data_Semigroup.append(Data_Semigroup.semigroupArray)(sigPrefix)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(toPSType)(v.value0.inputs))([ toReturnType(v.value0.constant)(Data_Functor.map(Data_Functor.functorArray)(toPSType)(v.value0.outputs)) ])), 
              unpackExpr: {
                  name: lowerCase(opts.prefix + v.value0.name), 
                  stockArgs: stockVars, 
                  payloadArgs: conVars
              }, 
  ...
  var funToFunctionCodeBlock = function (f) {
      return function (opts) {
          return new FunctionCodeBlock(funToDataDecl(f)(opts), funToEncodingInstance(f)(opts), funToHelperFunction(f)(opts));
      };
  };
  var codeAbi = new Code(function (v) {
      return function (opts) {
          var genCode$prime = function (at) {
              if (at instanceof Data_AbiParser.AbiFunction) {
                  return genCode(codeFunctionCodeBlock)(funToFunctionCodeBlock(at.value0)(opts))(opts);
              };
              if (at instanceof Data_AbiParser.AbiEvent) {
                  return genCode(codeFunctionCodeBlock)(eventToEventCodeBlock(at.value0))(opts);
              };
              return "";
          };
          return Data_String.joinWith("\x0a\x0a")(Data_Functor.map(Data_Functor.functorArray)(genCode$prime)(v));
      };
  });
      ...
      return function (abiFile) {
          return function (destFile) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Argonaut_Parser.jsonParser)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(abiFile)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($184) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error($184));
                  })(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(v))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($185) {
                          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error($185));
                      })(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(parseAbi(opts)(v1)))(function (v2) {
                          return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(destFile)(genPSModuleStatement(opts)(destFile) + ("\x0a" + (imports + ("\x0a" + genCode(codeAbi)(v2)(opts)))));
                      });
                  });
              });
          };
  ...
  var generatePS = function (os) {
      ...
      var opts = (function () {
          var $175 = {};
          for (var $176 in os) {
              if ({}.hasOwnProperty.call(os, $176)) {
                  $175[$176] = os[$176];
              };
          };
          $175.pursDir = os.pursDir + "/Contracts";
          return $175;
      })();
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(opts.jsonDir))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(opts.pursDir))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                  ...
                  return Node_FS_Aff.mkdir(opts.pursDir);
              })())(function (v2) {
                  if (v.length === 0) {
                  ...
                  return Data_Functor["void"](Control_Monad_Aff.functorAff)(Data_Traversable["for"](Control_Monad_Aff.applicativeAff)(Data_Traversable.traversableArray)(Data_Array.filter(function (f) {
  ...
  exports["ParserMethod"] = ParserMethod;
  exports["Code"] = Code;
  exports["callSigPrefix"] = callSigPrefix;
  exports["capitalize"] = capitalize;
  exports["eventId"] = eventId;
  exports["eventToDataDecl"] = eventToDataDecl;
  exports["eventToEncodingInstance"] = eventToEncodingInstance;
  ...
  exports["eventToParser"] = eventToParser;
  exports["eventToParserNoArgs"] = eventToParserNoArgs;
  exports["eventToParserSomeArgs"] = eventToParserSomeArgs;
  exports["funToBuilder"] = funToBuilder;
  exports["funToBuilderNoArgs"] = funToBuilderNoArgs;
  exports["funToBuilderSomeArgs"] = funToBuilderSomeArgs;
  exports["funToDataDecl"] = funToDataDecl;
  exports["funToEncodingInstance"] = funToEncodingInstance;
  ...
  exports["sendSigPrefix"] = sendSigPrefix;
  ...
  exports["codeAbiEncodingInstance"] = codeAbiEncodingInstance;
...
(function(exports) {
  ...
  var generatorMain = (function () {
      ...
      var setup = Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.usage("$0 --abis ./contract-abis --dest destination -"))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.example("$0 --abis ./contract-abis")("Generate contracts in current directory"))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.defaultVersion)(Node_Yargs_Setup.defaultHelp)));
      return Node_Yargs_Applicative.runY(setup)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Data_Functor.map(Node_Yargs_Applicative.functorY)(go)(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argString)("abis")([  ])(Data_Maybe.Nothing.value)(new Data_Either.Right("Must specify abi source directory."))(true)))(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argString)("dest")([  ])(Data_Maybe.Nothing.value)(new Data_Either.Left("./src"))(false)))(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argString)("prefix")([  ])(Data_Maybe.Nothing.value)(new Data_Either.Left(""))(false)))(Node_Yargs_Applicative.flag("truffle")([  ])(new Data_Maybe.Just("Are the abi files truffle artifacts"))));
  })();
